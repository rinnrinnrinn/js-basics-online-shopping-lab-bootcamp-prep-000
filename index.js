...
function placeOrder(cardNumber) {
  if (cardNumber === false) {return "Sorry, we don't have a credit card on file for you."}
  else if(cardNumber === true) {cart.splice(i, i); return `Your total cost is ` + total + `, which will be charged to the card ${cardNumber}.`
}
}
